# Test script where the oligomers and dimers are directly routed to the boiler turbo generator containing a lot of water. And apparently in the boiler turbo generator, water absorbs a lot of the latent heat and hence the LHV of the stream is very low
