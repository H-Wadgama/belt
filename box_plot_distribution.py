...
df = pd.read_excel(
    os.path.join(_dir, 'lignin_saf', 'uncertainty-gsa', 'combined_3000_trial_1.xlsx'),
...
ax_kde.fill_between(x_range, kde_values, color='#acbcd3', alpha=0.6)
...
ax_kde.set_xlabel('MSP of SAF (USD/gal)', fontsize=12, color='black')
...
ax_box.boxplot(
    ...
    widths=0.5,
    patch_artist=True,
    boxprops={"facecolor": "#8aa2c1", "edgecolor": 'black', "linewidth": 1},
...
plt.savefig('box_plot_distribution_combined.png', dpi=600, bbox_inches='tight')
plt.savefig('box_plot_distribution_combined.svg', bbox_inches='tight')
plt.show()
