...
from lignin_saf.settings.tea_params import labor
...
print(f'Baseline (constant 330 days/yr) MJSP: {baseline_mjsp} USD/gal')
print(f'Variable (random 250-330 days/yr) MJSP: {variable_mjsp} USD/gal')
